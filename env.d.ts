...
type DecodedUserKind = 'student' | 'register' | 'teacher' | 'admin';
...
declare module 'express' {
  interface Response {
    ...
    responseError: (code: string, show: string, error: ErrorResType) => void;
    responseAppError: (err: ErrorStruct) => void;
    responseFailAuth: (code: string, show: string, error: ErrorResType) => void;
