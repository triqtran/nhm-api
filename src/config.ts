...
const getConfig = (): ENV => {
  return {
    ...
    JWT_EXPIRED_DAY: process.env.JWT_EXPIRED_DAY
      ? Number(process.env.JWT_EXPIRED_DAY)
      : 30,
    ...
    AYOTREE_LIST_COURSES_BY_CAMPUS: process.env
      .AYOTREE_LIST_COURSES_BY_CAMPUS as string,
    AYOTREE_LIST_LESSONS_BY_CAMPUS_AND_TEACHER: process.env
      .AYOTREE_LIST_LESSONS_BY_CAMPUS_AND_TEACHER as string,
    AYOTREE_LIST_USERS_BY_TYPE: process.env
      .AYOTREE_LIST_USERS_BY_TYPE as string,
    ...
    AYOTREE_LIST_STUDENTS_BY_CAMPUS: process.env
      .AYOTREE_LIST_STUDENTS_BY_CAMPUS as string,
    AYOTREE_GET_STUDENT_ID: process.env.AYOTREE_GET_STUDENT_ID as string,
    AYOTREE_UPDATE_STUDENT_STATUS_BY_ID_AND_CAMPUS: process.env
      .AYOTREE_UPDATE_STUDENT_STATUS_BY_ID_AND_CAMPUS as string,
    AYOTREE_GET_TEACHER_TEACHING_AVAILABILITY_SCHEDULE: process.env
      .AYOTREE_GET_TEACHER_TEACHING_AVAILABILITY_SCHEDULE as string,
    ...
    MAILER_AUTH_TYPE: process.env.MAILER_AUTH_TYPE as string,
    SENDER_MAIL: process.env.SENDER_MAIL as string,
    SENDER_PASSWORD: process.env.SENDER_PASSWORD as string,
    MAILER_CLIENT_ID: process.env.MAILER_CLIENT_ID as string,
    MAILER_CLIENT_SECRET: process.env.MAILER_CLIENT_SECRET as string,
    MAILER_REFRESH_TOKEN: process.env.MAILER_REFRESH_TOKEN as string,
  };
};
